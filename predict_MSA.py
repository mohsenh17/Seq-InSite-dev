...
def protToDict(datasetAddress):
    ...
    while True:
        ...
        prot_file = open('../msaTransformer/dset500/embd/{}.embd'.format(line_PID))
...
def Predict(test_all_features_np3D, input_file):
    ...
    model.load_weights("models/MLP_MSA_L9_survey.h5") 
    ...
    while True:
        ...
        if not line_Pseq:
            break
        fout = open("Out_MSA_MLP_500/"+line_PID.upper()+".txt", "w")
...
def main():
    input_file = '../msaTransformer/dataset/Dset_500Less_Pid_Pseq.txt'
