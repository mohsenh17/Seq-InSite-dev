        ...
        for neighbor in neighborList:
            if neighbor != 'Zpad':
                try:
                    ...
                    selectedFeatureMSA.append(np.zeros(1536))
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        for i,item in enumerate(list_IDs_temp):
            ...
            if len(protDictChunk[protName]) == 0:
                ...
                protDictMSA = self.protToDict(protName, "../ankh/ankhEmbd")
...
trainPartition = partitioning("../surveyComp/dataset/NewtrainPlus50EditedDset500T335_Pid_Pseq_label.txt")
