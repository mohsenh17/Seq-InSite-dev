...
#out2 = Dropout(rate=0.3)(input_features)
out2 = Flatten()(input_features)
out2 = Dense(1024, activation='relu', name="dense_T5_0")(out2)
out2 = Dropout(rate=0.3)(out2)
#out3 = Dense(768, activation='relu', name="dense_MSA_0")(input_features2)
#out3 = Dropout(rate=0.3)(out3)
out3 = Flatten()(input_features2)
out3 = Dense(768, activation='relu', name="dense_MSA_0")(out3)
out3 = Dropout(rate=0.3)(out3)
...
mc = ModelCheckpoint("models/MLP_T5_MSA_without315_4Layer.h5",
