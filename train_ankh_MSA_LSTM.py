        ...
        for neighbor in neighborList:
            if neighbor != 'Zpad':
                try:
                    ...
                    selectedFeature.append(np.zeros(1536))
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        for i,item in enumerate(list_IDs_temp):
            ...
            if len(protDictChunk[protName]) == 0:
                protDict = self.protToDict(protName, "../ankh/ankhEmbd/")
                protDictMSA = self.protToDict(protName, "../surveyComp/msaEmbd/")
...
mc = ModelCheckpoint("models/LSTM_ankh_MSA_without70.h5",
